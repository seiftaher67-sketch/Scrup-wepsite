...
export default function ReturnRequest() {
    ...
    const handleSubmit = async (e) => {
        ...
        // Mock success - show success modal without backend
        ...
        return (
            <div className="pt-32 pb-24 container mx-auto px-6" dir="rtl">
                <div className="max-w-6xl mx-auto text-center">
                    <div className="text-2xl">جاري تحميل بيانات الطلب...</div>
                </div>
            </div>
        );
    }
    ...
    if (error) {
        return (
            <div className="pt-32 pb-24 container mx-auto px-6" dir="rtl">
                <div className="max-w-6xl mx-auto text-center">
                    <div className="text-2xl text-red-600 mb-4">خطأ في تحميل البيانات</div>
                    <div className="text-lg mb-4">{error}</div>
                    <button
                        onClick={() => navigate(`/track-order/${orderNumber}`)}
                        className="bg-blue-500 text-white px-6 py-2 rounded"
                    >
                        العودة إلى تتبع الطلب
                    </button>
                </div>
            </div>
        );
    ...
    if (!order) {
        return (
            <div className="pt-32 pb-24 container mx-auto px-6" dir="rtl">
                <div className="max-w-6xl mx-auto text-center">
                    <div className="text-2xl">لم يتم العثور على الطلب</div>
                </div>
            </div>
        );
    }
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="mb-8" style={{ marginTop: '60px' }}>
                    ...
                    <p style={{
                        ...
                        marginTop: '30px',
                        fontWeight: 'bold'
                    }}> رقم الطلب : {order.order_number}</p>
                </div>
                            ...
                            {order.items.map(item => (
                                ...
                                >
                                    <div className="flex items-center gap-6 flex-1">
                                        ...
                                        />
                                        <img
                                            src={item.product?.images?.[0] || '/image/staf1.jpg'}
                                            alt="item"
                                        ...
                                        <div className="text-right flex-1">
                                            ...
                                            <div className="text-xs text-gray-500" style={{
                                                ...
                                                المقاس: <span style={{
                                                    ...
                                                    letterSpacing: '0px',
                                                    color: '#000000'
                                                }}>{item.product?.sizes?.[0] || 'غير محدد'}</span>
                                            </div>
                                            <div className="text-xs text-gray-500" style={{
                                                fontFamily: 'Cairo',
                                                fontWeight: 400,
                                                ...
                                                اللون: <span style={{
                                                    ...
                                                    letterSpacing: '0px',
                                                    color: '#000000'
                                                }}>{item.product?.colors?.[0] || 'غير محدد'}</span>
                                            </div>
                                            <div className="text-xs text-gray-500" style={{
                                                fontFamily: 'Cairo',
                                                fontWeight: 400,
                                    ...
                                    <div style={{
                                        ...
                                        {item.unit_price} <img src="/image/ry.jpeg" alt="ريال" style={{ width: '20px', height: '20px', verticalAlign: 'middle', marginLeft: '4px' }} />
                                    </div>
                                </div>
                            ))}
                        </div>
